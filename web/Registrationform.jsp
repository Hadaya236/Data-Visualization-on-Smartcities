...
<table align="center" width="100%" border="5">
	...
	<div class="sidenav A">
		<fieldset><legend><img src="Images\btn-view.gif"></legend>
			...
			<a href="hotels.jsp">Hotels</a></a></fieldset>
		</div></td>
		<td align="center">
			<div style="font-size: 28pt;color:blue;font-style: italic;font-weight:bold;">Register Form</div>
			<form action="retrive.jsp" onsubmit="return valid()">
				...
				<tr>
					<td></td>
						<td align="left"><input type="radio" name="r1" value="business">Business Person</td>
				...
				<tr>
					...
					<tr><td align="right">CAPTCHA</td><td><input type="text" name="pin" ></td>
