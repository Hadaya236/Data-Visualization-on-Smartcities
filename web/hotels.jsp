	...
	<table align="center"><tr>
		...
		<tbody><tr>
			<td align="right" valign="middle" width="776"><div class="innner_bodybg" style="width: 779px;">
				...
				<div style="float: left; padding-top: 8px; font-family: arial; font-size: 14px; color: rgb(0, 0, 0); font-weight: bold;">Hotels in Ramnad</div> 
				</div>
				<div>
				<table align="center" cellpadding="0" cellspacing="0" width="776">
					<tbody>
                                        ...
                                        <tr>
				<td  align="left" bgcolor="#ddeaf6" valign="middle" height="20"><span class="train_h1">&nbsp;IBRISS HOTEL  </span></td>
			</tr>
		<tr>
                    <td class="inner_border" align="left" valign="top">
                         Head Post Office Near<br>
                         Sivan Koil Road<br>
                         Ramanathapuram<br>
