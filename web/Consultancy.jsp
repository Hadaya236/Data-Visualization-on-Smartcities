...
<table align="center" width="100%" border="5">
    ...
    <div style="float: left; padding-top: 8px; font-family: arial; font-size: 14px; color: rgb(0, 0, 0); font-weight: bold;">Consultants in Vizag</div>
                            </div>
                            <div>
                              <table align="center" cellpadding="0" cellspacing="0" width="776">
                                
                                <tbody><tr>
                                  <td class="inner_border" align="left" valign="top" width="194">Industrial<br>
Project Sales Corp<br>
28, Founta   Plaza,<br>
Suryabagh<br>
Visakapatnam - 530020<br>
Phone:+91-891-2564393<br>
Fax:+91-891-2590482<br>
satish@projectsalescorp.com</td>
