	...
	<table align="center"><tr>
		...
		<tbody><tr>
			<td align="right" valign="middle" width="776"><div class="innner_bodybg" style="width: 779px;">
				...
				<div style="float: left; padding-top: 8px; font-family: arial; font-size: 14px; color: rgb(0, 0, 0); font-weight: bold;">BLOOD BANK Locations in Ramnad</div> 
				</div>
				<div>
				<table align="center" cellpadding="0" cellspacing="0" width="776">
					...
					<tr>
				<td colspan="4" align="left" bgcolor="#ddeaf6" valign="middle" height="20"><span class="train_h1">&nbsp;Ramnad Blood Bank( Run by C. Lakshmiammal Memorial Trust) </span></td>
			</tr>
		<tr>
                    <td class="inner_border" align="left" valign="top">
                        Phone:<BR>
                        Landline:<BR>
                        Address: No. 1/225, Malligai Illam Mahasakthi Nagar, <BR>
                        Ramanathapuram, <BR>
                        Tamil Nadu - 625503<BR>
                    </td>
			
		</tr>
		<tr>
			<td colspan="4" align="left" bgcolor="#ddeaf6" valign="middle" height="20"><span class="train_h1">&nbsp;Government Headquarters Hospital Blood Bank</span></td></tr>
		<tr>
                    <td class="inner_border" align="left" valign="top" width="194">
                        Phone:<BR>
                        Landline: 04567-228178<BR>
                        Address: Government Headquarters Hospital,<BR>
                        Ramanathapuram,<BR> 
                        Tamil Nadu - 623501<BR>
