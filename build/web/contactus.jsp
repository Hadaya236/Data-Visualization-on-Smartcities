	...
	<table align="center"><tr>
		...
		<tbody><tr>
			<td align="right" valign="middle" width="776"><div class="innner_bodybg" style="width: 779px;">
				...
				<div style="float: left; padding-top: 8px; font-family: arial; font-size: 24px; color: blue; font-weight: bold;">Contact Us</div> 
				</div>
				<div>
				...
				<table align="center" cellpadding="0" cellspacing="0" width="776">
					...
					<tr>
				<td colspan="4" align="left" bgcolor="#ddeaf6" valign="middle" height="20"><span class="train_h1">&nbsp;Syed Hameedha Arts And Science , 
                           Kilakarai. </span></td>
			</tr>
