...
<html>
  <head>
    <base href="<%=basePath%>">
    <title>Ramnad Education Photo Gallery page</title>
...
<table style="position:absolute;left:200pt;top:350pt;">
    <tr>
        <td>
            <img src="simages\sathak.jpg" height="250" width="250">
        </td>
        <td>
            <img src="simages\syedammal.jpg" height="250" width="250">
        </td>
       
    </tr>
    <tr align="center">
        <td><a href="student2.jsp#sathak" style="font-size:12t;">Mohamed Sathak Engineering College</a></td>
         <td><a href="student2.jsp#syedammal" style="font-size:12t;">Syed Ammal Engineering College</a></td>
