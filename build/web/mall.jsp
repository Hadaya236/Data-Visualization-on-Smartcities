	...
	<table align="center"><tr>
		...
		<tbody><tr>
			<td align="right" valign="middle" width="776"><div class="innner_bodybg" style="width: 779px;">
				...
				<div style="float: left; padding-top: 8px; font-family: arial; font-size: 14px; color: rgb(0, 0, 0); font-weight: bold;">Shopping Mall in Ramnad</div> 
				</div>
				<div>
				<table align="center" cellpadding="0" cellspacing="0" width="776">
					<tbody>
                                        ...
                                        <tr>
				<td  align="left" bgcolor="#ddeaf6" valign="middle" height="20"><span class="train_h1">&nbsp;SATHAK CENTRE  </span></td>
			</tr>
		<tr>
                    <td class="inner_border" align="left" valign="top">
                         G.H Road<br>
                         Near Bus stand<br>
                        Phone : 091503 46790<br>
                    </td>
			
		</tr>
		
                                        <tr>
				<td  align="left" bgcolor="#ddeaf6" valign="middle" height="20"><span class="train_h1">&nbsp;ELAHI SHOPPING MALL </span></td>
			</tr>
		<tr>
                    <td class="inner_border" align="left" valign="top">
                        Trichy Rameshwaram Main Road<br>
                         Near Bus stand<br>
                        Phone : 09150776790<br>
                    </td>
                                        ...
                                        <tr>
				<td  align="left" bgcolor="#ddeaf6" valign="middle" height="20"><span class="train_h1">&nbsp;GOLDEN SHOPPING MALL </span></td>
			</tr>
		<tr>
                    <td class="inner_border" align="left" valign="top">
                        Rameshwaram Main Road<br>
                        Bharathi Nagar<br>
                        Phone : 09150556790<br>
                    </td>
